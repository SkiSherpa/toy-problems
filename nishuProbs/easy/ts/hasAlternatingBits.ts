...
// t = O(n), I have to loop through the each item in bits.
// I don't know the runtime of toString(2) off the top of my head.
// n.toString(2) == log_2(n), so still linear
// m = O(1), NOT CORRECT
// m = O(log(n)), the storing of the binary string is O(log(n))
